...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_depth", lower = 1L, upper = 31L),
  ...
  makeNumericParam("lambda_L1", lower = 0, upper = 20),
  makeNumericParam("lambda_L2", lower = 0, upper = 20),
  makeNumericParam("min_gain_to_split", lower = 0, upper = 20),
  makeNumericParam("drop_rate", lower = 0, upper = 1)
)
