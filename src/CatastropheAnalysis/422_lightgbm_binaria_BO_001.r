...
hs <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 20L, upper = 100L),
  makeNumericParam("feature_fraction", lower = 0.6, upper = 0.8),
  makeIntegerParam("min_data_in_leaf", lower = 10L, upper = 50L),
  makeIntegerParam("envios", lower = 500L, upper = 3000L),
  makeIntegerParam("max_depth", lower = 4L, upper = 12L),
  makeNumericParam("min_sum_hessian_in_leaf", lower = 0.1, upper = 10),
  ...
  makeNumericParam("min_bin", lower = 5, upper = 50)
)
